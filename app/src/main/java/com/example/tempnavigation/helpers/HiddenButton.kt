...
import com.example.tempnavigation.listener.ButtonClickListener
...
class HiddenButton(
    ...
    fun onDraw(c:Canvas, rectF: RectF,pos:Int){
        ...
        if (imageResId == 0){
            ...
            val left = (rectF.left+rectF.right)/2
            val top = (rectF.top+rectF.bottom)/2
    ...
    private fun drawableToBitmap(d: Drawable?): Bitmap {
        ...
        val bitmap = Bitmap.createBitmap(d!!.intrinsicWidth,d.minimumHeight,Bitmap.Config.ARGB_8888)
